...
class PISpider(scrapy.Spider):
    ...
    venta_urls = [
        "https://www.portalinmobiliario.com/venta/la-florida-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/venta/las-condes-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/venta/lo-barnechea-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/venta/providencia-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/venta/santiago-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/venta/vitacura-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/venta/nunoa-metropolitana?filter=city",
    ]
    arriendo_urls = [
        "https://www.portalinmobiliario.com/arriendo/las-condes-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/arriendo/providencia-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/arriendo/vitacura-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/arriendo/santiago-metropolitana?filter=city",
        "https://www.portalinmobiliario.com/arriendo/nunoa-metropolitana?filter=city",
    ]
    start_urls = [
        "{}/".format(url_base),
    ]
